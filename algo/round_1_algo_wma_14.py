...
class Trader:
    ...
    window_size = 100  # Set the number of prices to consider for the weighted moving average
        ...
        for product in state.order_depths.keys():
            ...
            if len(order_depth.sell_orders) > 0:
                ...
                if best_ask < fair_price:
                    ...
                    state.position[product] = state.position.get(product, 0) - best_ask_volume
            ...
            if len(order_depth.buy_orders) > 0:
                ...
                if best_bid > fair_price:
                    ...
                    state.position[product] = state.position.get(product, 0) - best_bid_volume
